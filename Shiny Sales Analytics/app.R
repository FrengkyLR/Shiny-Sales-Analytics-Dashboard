...
ui = dashboardPage( skin = "blue",
                    ...
                    dashboardSidebar(
                      sidebarMenu(
                        ...
                        menuItem("About Me", icon = icon("github"), href = "https://github.com/FrengkyLR")
                                )
                                  ),
...
server = function(input, output) {
  showNotification("Created by Frengky.LR  ", duration = NULL, type = "message")
  ...
  output$hist1 <- renderPlotly({
    ...
    text <- paste("Cara Menggunakan Sales Analytics Dashboard: \n 1.Klik Browser Button disamping \n 2.Pilih File dalam Format xlsx, untuk analisa dashboard ini pilih file sales_data.xlsx \n 3.Mulai eksplorasi Sales Analytics Dashboard")
